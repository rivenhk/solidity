...
BOOST_AUTO_TEST_CASE(basic_compilation)
{
	...
	BOOST_CHECK_EQUAL(
		...
		"60606040523415600e57600080fd5b603a80601b6000396000f30060606040526004361050600080fd00"
	);
	...
	BOOST_CHECK(contract["evm"]["assembly"].asString().find(
		...
		"  0x0\n  dup1\n  revert\ntag_1:\n  dataSize(sub_0)\n  dup1\n  dataOffset(sub_0)\n  0x0\n  codecopy\n  0x0\n"
		"  return\nstop\n\nsub_0: assembly {\n        /* \"fileA\":0:14  contract A { } */\n"
		"      mstore(0x40, 0x60)\n      pop(lt(calldatasize, 0x4))\n      0x0\n      dup1\n      revert\n\n"
		"    auxdata: 0xa165627a7a7230582") == 0);
	BOOST_CHECK(contract["evm"]["gasEstimates"].isObject());
	BOOST_CHECK_EQUAL(
		dev::jsonCompactPrint(contract["evm"]["gasEstimates"]),
		"{\"creation\":{\"codeDepositCost\":\"11600\",\"executionCost\":\"61\",\"totalCost\":\"11661\"}}"
	);
